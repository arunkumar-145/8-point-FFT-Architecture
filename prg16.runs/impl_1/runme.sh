...
HD_PWD='D:/FFT/FFT Architecture/prg16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft8_implementation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft8_implementation.tcl -notrace

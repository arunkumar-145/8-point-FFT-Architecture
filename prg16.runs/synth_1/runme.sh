...
HD_PWD='D:/FFT/FFT Architecture/prg16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft8_implementation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft8_implementation.tcl
